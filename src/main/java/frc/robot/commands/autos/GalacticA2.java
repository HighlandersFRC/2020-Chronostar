...
public class GalacticA2 extends SequentialCommandGroup {
    private Trajectory trajectory;
    private PurePursuit purePursuit;

    public GalacticA2(Drive drive, Peripherals peripherals, Odometry odometry) {
        try {
            trajectory =
                    TrajectoryUtil.fromPathweaverJson(
                            Paths.get("/home/lvuser/deploy/GalacticSearchA2.json"));
        } catch (IOException e) {
            e.printStackTrace();
        }
